    ...
    <div className="site-shell">
      <header className="topbar">
        <div className="topbar-inner">
          ...
          <Link className="nav-cta" to="/compare">
            <FaArrowRight />
            View Comparisons
          </Link>
        </div>
      ...
      <footer className="footer">
        <div className="footer-inner">
          ...
          <div className="footer-section">
            <h3>KC Metro Locations</h3>
            <div className="footer-grid">
              {cityPages.slice(0, 18).map((city) => (
        ...
        <div className="footer-bottom">
          <p>© {new Date().getFullYear()} {siteMeta.brand} — Independent Kansas City tree service comparison guide.</p>
          <p>Not affiliated with any provider. Information sourced from publicly available data.</p>
        </div>
      </footer>
    </div>
  )
